...
/** Create a lispbm array from a C array. The array should be created while the evaluater
 * is paused and the array should be bound to something before unpausing. Send the array in
